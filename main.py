...
def parse_args():
    ...
    parser.add_argument('--position_embedding_dim', type=int, default=16)
    parser.add_argument('--position_embedding_max_freq', type=int, default=256)
    ...
    parser.add_argument('--scheduled_sampling_k', type=float, default=1)
    parser.add_argument('--scheduled_sampling_decay', type=str, default='linear')
    parser.add_argument('--scheduled_sampling_limit', type=float, default=0)
